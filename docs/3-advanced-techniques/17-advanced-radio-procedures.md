...
This chapter covers the use of the radio and contains all information you need to properly utilize your radio during an operation.

This should supply you with a quick understanding of what we expect regarding the use of radio and how you should communicate with your fellow members. Good communication is a **very** important part of any operation as it will greatly improve the experience of everyone involved.

## 2. Radio Protocols

1. Make sure that your message is **clear**.
2. Keep messages as **short and concise** as possible.
3. Always acknowledge that you **received and understood** the order given.
4. If your last message had the **incorrect information**, **correct it immediately** and **send** again.
...
The Radio Telephone Operator (RTO) is the link between the Commander and all other elements. Their role is to monitor all relevant radio channels, relay communications between the different elements, and to transmit the commander's orders.

To achieve this, the RTO is expected to carry as many radios as necessary. To illustrate- for one Section (like wolfpack) and one artillery battery (hammer), the RTO loadout would be :

- 2 x 343
  - 1 for the command squad the RTO is part of.
  - 1 for any squad the RTO may need to contact or attach themselves to.
- 3 x 152
...
More radios may be required to cover all channels depending on the elements present during an operation. The use of a 117 may be required for elements operating farther away.
